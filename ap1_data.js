...
const rawDB = [
    ...
    { t: 'b', p: 1, n: 'Scapula', r: 'Appendicular (Pectoral Girdle)', l: 'Body, spine, superior/medial/lateral borders, glenoid cavity, coracoid process, acromion process, subscapular fossa' },
    ...
    { t: 'b', p: 1, n: 'Os Coxa (Pelvis)', r: 'Appendicular (Pelvic Girdle)', l: 'Ilium (iliac crest, ASIS, AIIS, greater sciatic notch), Ischium (spine, lesser sciatic notch, ischial tuberosity), Pubis (pubic symphysis), Acetabulum, Obturator foramen' },
    ...
    { t: 'm', p: 1, n: 'Masseter', o: 'Zygomatic arch', i: 'Lateral surface of mandibular ramus and angle', a: 'Elevates mandible & closes jaw (primary mastication)' },
    ...
    { t: 'm', p: 1, n: 'Pectoralis Major', o: 'Clavicle, sternum & ribs (2-6)', i: 'Greater tubercle & intertubercular groove of humerus', a: 'Flexes, adducts, & medially rotates humerus' },
    { t: 'm', p: 1, n: 'Latissimus Dorsi', o: 'Spinous processes of inferior thoracic / lumbar vertebrae, ribs & iliac crest', i: 'Intertubercular groove of humerus', a: 'Extends, adducts, & medially rotates humerus' },
    { t: 'm', p: 1, n: 'Deltoid', o: 'Clavicle & scapula', i: 'Deltoid tuberosity of humerus', a: 'Prime mover of humerus abduction' },
    ...
    { t: 'm', p: 1, n: 'Rectus Abdominis', o: 'Pubis', i: 'Costal cartilage of ribs 5-7 & xiphoid process', a: 'Depresses ribs, flexes vertebral column' },
    ...
    { t: 'm', p: 1, n: 'Gastrocnemius', o: 'Condyles of femur', i: 'Calcaneous via calcaneal tendon', a: 'Plantar flexes foot, flexes lower leg at knee' },
    { t: 'm', p: 1, n: 'Trapezius', o: 'Occipital bone, ligamentum nuchae, and spinous processes of all thoracic vertebrae', i: 'Clavicle & acromion and spine of scapula', a: 'Elevates, retracts, depresses, or rotates scapula; extends neck' },
    ...
    { t: 'm', p: 2, n: 'Erector Spinae', o: 'Iliac crest, vertebrae, and ribs 3-6', i: 'Ribs and vertebrae above the origin', a: 'Extends vertebral column and/or neck; lateral flexion' },
    ...
    { t: 'm', p: 2, n: 'Tensor Fasciae Latae', o: 'Iliac crest & anterior superior iliac spine', i: 'Iliotibial tract', a: 'Flexes and medially rotates thigh; tenses fascia lata' },
    ...
    { t: 'm', p: 2, n: 'Peroneus Longus', o: 'Lateral condyle of tibia & fibula', i: 'Base of 1st metatarsal & medial cuneiform bone', a: 'Plantar flexes & everts foot; supports longitudinal arch' },
    { t: 'm', p: 2, n: 'Peroneus Brevis', o: 'Fibula', i: 'Base of 5th metatarsal', a: 'Plantar flexes & everts foot' },
